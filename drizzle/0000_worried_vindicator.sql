...
CREATE INDEX "_CampaignPlayers_B_index" ON "_CampaignPlayers" USING btree ("B" text_ops);--> statement-breakpoint
...
CREATE INDEX "_InvitedGame_B_index" ON "_InvitedGame" USING btree ("B" text_ops);
